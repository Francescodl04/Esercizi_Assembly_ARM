...
.text
NWORD:
	PUSH {LR, FP}		@ salva FP e indirizzo di ritorno
...
LOOPW:  
        MOV   R1, #0            @ valore iniziale del contatore di caratteri
LOOPI:  
        LDRB  R4,[R2], #1	@ carattere in R4, poi punta al successivo
...
LOOP:   
        LDRB  R4, [R2], #1	@ caratt. successivo in R4 e incr. puntatore
...
INLOOP:   
        B INLOOP		@ fine programma (loop infinito)
...
.bss
              .align 4
              .space 1024	@ spazio per lo stack
